...
export type DeployAppVersionsSortBy = "NEWEST" | "OLDEST" | "%future added value";
export type srcListAppVersionsQuery$variables = {
  ...
  sortBy?: DeployAppVersionsSortBy | null | undefined;
};
export type srcListAppVersionsQuery$data = {
  readonly node: {
    readonly versions?: {
...
export type srcListAppVersionsQuery = {
  response: srcListAppVersionsQuery$data;
  variables: srcListAppVersionsQuery$variables;
};
            ...
            "selections": [
              {
                "alias": null,
                "args": (v8/*: any*/),
                "concreteType": "DeployAppVersionConnection",
                "kind": "LinkedField",
                "name": "versions",
                "plural": false,
                "selections": [
                  {
                    "alias": null,
                    "args": null,
                    "concreteType": "DeployAppVersionEdge",
                    "kind": "LinkedField",
                    "name": "edges",
                    "plural": true,
                    "selections": [
...
(node as any).hash = "0aae2dd30f72f34a8b4d79752587116b";
